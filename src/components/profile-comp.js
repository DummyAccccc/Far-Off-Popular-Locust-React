    ...
    <div className={`profile-comp-container ${props.rootClassName} `}>
      ...
      <div className="profile-comp-container01">
        ...
        <div className="profile-comp-container28">
          ...
          <button type="button" className="profile-comp-button01 button">
            {props.button26}
          </button>
          <button type="button" className="profile-comp-button02 button">
            {props.button25}
          </button>
          <button type="button" className="profile-comp-button03 button">
            {props.button24}
          </button>
          <button type="button" className="profile-comp-button04 button">
            {props.button23}
          </button>
          <button type="button" className="profile-comp-button05 button">
            {props.button22}
          </button>
          <button type="button" className="profile-comp-button06 button">
            {props.button211}
          </button>
          <button type="button" className="profile-comp-button07 button">
            {props.button2112}
          </button>
        </div>
      </div>
      ...
      <div className="profile-comp-container29">
        ...
        <div className="profile-comp-container41">
          <button type="button" className="profile-comp-button08 button">
            {props.button27}
          </button>
          <button type="button" className="profile-comp-button09 button">
            {props.button261}
          </button>
          <button type="button" className="profile-comp-button10 button">
            {props.button251}
          </button>
        </div>
      </div>
