  ...
  return (
    <div className={`sidebar-sidebar ${props.rootClassName} `}>
      <div className="sidebar-container">
        <div className="sidebar-container01">
      ...
      <div className="sidebar-container02">
        <div className="sidebar-container03">
      ...
      <div className="sidebar-container04">
        <div className="sidebar-container05">
          ...
          <span className="sidebar-text2 button">{props.text2}</span>
        </div>
      </div>
      <div className="sidebar-container06">
        <div className="sidebar-container07">
          <svg viewBox="0 0 1073.7371428571428 1024" className="sidebar-icon07">
            <path
      ...
      <div className="sidebar-container08">
        <div className="sidebar-container09">
          <div className="sidebar-container10">
